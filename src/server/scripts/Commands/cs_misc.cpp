...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand sendCommandTable[] =
        {
            ...
            { "mail",               SEC_EVENT_MASTER,          true,  &HandleSendMailCommand,              "", NULL },
        ...
        static ChatCommand commandTable[] =
        {
            ...
            { "appear",             SEC_EVENT_MASTER,          false, &HandleAppearCommand,                "", NULL },
            { "summon",             SEC_EVENT_MASTER,          false, &HandleSummonCommand,                "", NULL },
            { "groupsummon",        SEC_EVENT_MASTER,          false, &HandleGroupSummonCommand,           "", NULL },
            ...
            { "recall",             SEC_EVENT_MASTER,          false, &HandleRecallCommand,                "", NULL },
            { "save",               SEC_PLAYER,             false, &HandleSaveCommand,                  "", NULL },
            { "saveall",            SEC_EVENT_MASTER,          true,  &HandleSaveAllCommand,               "", NULL },
            ...
            { "send",               SEC_EVENT_MASTER,          true,  NULL,                                "", sendCommandTable },
            { "pet",                SEC_GAMEMASTER,         false, NULL,                                "", petCommandTable },
            { "mute",               SEC_EVENT_MASTER,          true,  &HandleMuteCommand,                  "", NULL },
            { "unmute",             SEC_EVENT_MASTER,          true,  &HandleUnmuteCommand,                "", NULL },
            ...
            { "freeze",             SEC_EVENT_MASTER,          false, &HandleFreezeCommand,                "", NULL },
            { "unfreeze",           SEC_EVENT_MASTER,          false, &HandleUnFreezeCommand,              "", NULL },
            { "listfreeze",         SEC_EVENT_MASTER,          false, &HandleListFreezeCommand,            "", NULL },
