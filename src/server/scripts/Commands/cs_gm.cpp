...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "chat",           SEC_EVENT_MASTER,      false, &HandleGMChatCommand,              "", NULL },
            ...
            { "visible",        SEC_EVENT_MASTER,      false, &HandleGMVisibleCommand,           "", NULL },
            { "",               SEC_EVENT_MASTER,      false, &HandleGMCommand,                  "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "gm",             SEC_EVENT_MASTER,      false, NULL,                     "", gmCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
    ...
    static bool HandleGMListFullCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        stmt->setUInt8(0, uint8(SEC_EVENT_MASTER));
