...
public:
    ...
    ChatCommand* GetCommands() const
    {
        static ChatCommand teleCommandTable[] =
        {
            ...
            { "name",           SEC_EVENT_MASTER,      true,  &HandleTeleNameCommand,            "", NULL },
            { "group",          SEC_EVENT_MASTER,      false, &HandleTeleGroupCommand,           "", NULL },
            { "",               SEC_EVENT_MASTER,      false, &HandleTeleCommand,                "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "tele",           SEC_EVENT_MASTER,      false, NULL,                   "", teleCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
