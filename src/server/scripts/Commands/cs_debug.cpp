...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "cinematic",      SEC_EVENT_MASTER,      false, &HandleDebugPlayCinematicCommand,   "", NULL },
            { "movie",          SEC_EVENT_MASTER,      false, &HandleDebugPlayMovieCommand,       "", NULL },
            { "sound",          SEC_EVENT_MASTER,      false, &HandleDebugPlaySoundCommand,       "", NULL },
        ...
        static ChatCommand debugCommandTable[] =
        {
            ...
            { "play",           SEC_EVENT_MASTER,      false, NULL,              "", debugPlayCommandTable },
            ...
            { "los",            SEC_EVENT_MASTER,      false, &HandleDebugLoSCommand,             "", NULL },
            { "moveflags",      SEC_ADMINISTRATOR,  false, &HandleDebugMoveflagsCommand,       "", NULL },
            { NULL,             SEC_PLAYER,         false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "debug",          SEC_EVENT_MASTER,      true,  NULL,                  "", debugCommandTable },
