...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand learnAllCommandTable[] =
        {
            ...
            { "default",        SEC_EVENT_MASTER,      false, &HandleLearnAllDefaultCommand,       "", NULL },
            { "lang",           SEC_EVENT_MASTER,      false, &HandleLearnAllLangCommand,          "", NULL },
        ...
        {
            { "learn",          SEC_EVENT_MASTER,      false, NULL,                                "", learnCommandTable },
