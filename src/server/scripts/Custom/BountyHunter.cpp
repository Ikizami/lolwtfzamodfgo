...
{ 
	...
	if(!pBounty)
	{
		m_session->SendNotification("The player is offline or doesn't exist, or check the spelling of the name!");
		return false;
	}
	...
	{
		m_session->SendNotification("Don't be funny, you can not set a bounty on your self!");
		return false;
	}
	return true;
}
